...
public class SetTest {
    ...
    public void testInsert() {
        ...
        // Insert duplicate items k and a and b.
        list.insert(k);
        assertEquals(k, list.retrieve());
        list.goToNext();
        assertEquals(k, list.retrieve());
    ...
    public void testRetrieve() {
        ...
        // Retrieve first
        list.goToFirst();
        letter = list.retrieve();
        assertEquals("Retrieve should return an equal object", a, letter);
        
        // Remove last and retreive new last
        list.goToLast();
        list.remove();
        letter = list.retrieve();
        assertEquals("Retrieve should return an equal object", d, letter);
    ...
    public void testFind() {
        ...
        assertFalse("Letter 'e' should not be found", list.find(e));
